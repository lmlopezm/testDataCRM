...
<html lang="es-ES">
    ...
    <body>
                                    ...
                                    <div class="col-12 text-sm-left">
                                        <a href="https://play.google.com/store/apps/details?id=com.datacrm.application" target="_blank">
                                            <picture>
                                                ...
                                                <img data-src="https://www.datacrm.com/front/images/home/home_banner_app_playstore.webp" alt="play store" width="150" height="60" class="effect-zoom ml-md-2 my-1 lazyload img-fluid" id="myImg">
                                            </picture>
                                        </a>
                ...
                <div >
                    <div class="row d-none d-lg-block">
                        ...
                        <div class="col-2 my-4" style="display: inline-flex;">
                                ...
                                <a href="https://www.facebook.com/DataCRM.Soluciones/"
                                    aria-label="facebook"
                                    target="_blank"
                                    style="font-size: 0px;"
                                >
                                ...
                                <a href="https://www.linkedin.com/company/datacrm/"
                                    aria-label="linkedin"
                                    target="_blank"
                                    style="font-size: 0px;"
                                    >
        ...
        <div class="modal-dialog modal-lg justify-content-center text-center align-items-center" role="document" style="max-width: 80rem ;">
            <div class="modal-content col-12 p-2 mb-2" id="modalcontent1"  style=" border-radius: 30px; padding-bottom: 3rem ;">
                    ...
                    <div class="col-lg-6 col">
                        ...
                        <div style="min-height: 80%; max-height: 80%;">
                            <form   id="api_popup_demo"
                                    ...
                                    novalidate
                                    >
                                <input type="hidden" name="_token" value="nGWz5DrlmyG4WckdPuei9H2SIM6wqEH2x2d294lA">
                    ...
                    <div class="col-6 d-none d-lg-block" style="border-left: 1px solid gray;">
                        ...
                        <div style="min-height: 80%; max-height: 80%;">
                            ...
                            <ul class="f-sz-sm myList text-left" id="myList">
                                <li>
                                    <div class="row" style="max-height: 2rem ;">
                                        <div class="col-1">
            ...
            <div class="row mt-lg-0 mt-5 ml-sm-2">
                <div
                    ...
                    id="modalloading"
                    style="display: none; max-width: 70rem ">
                    ...
                    <div>
                        ...
                        <img
                            class="img-fluid"
                            id="gif_loader3"
                            src="https://www.datacrm.com/front/images/crear-cuenta.gif"
                            loading="lazy"
                        >
